...
const VisualizerId = () => {
    ...
    const routeState = (location as any)?.state as VisualizerLocationState | undefined;
    ...
    const handleExport = () => {
        ...
        link.download = `roommind-${id || 'design'}.png`;
    ...
    useEffect(() => {
        ...
        const loadProject = async () => {
            ...
            } else if (routeState?.initialImage) {
                const localItem: DesignItem = {
                    id: id,
                    name: routeState?.name ?? `Residence ${id}`,
                    sourceImage: routeState.initialImage,
                    renderedImage: routeState.initialRender ?? null,
                    timestamp: Date.now(),
                    ownerId: userId ?? null,
                    isPublic: false,
                };
                setProject(localItem);
                setCurrentImage(localItem.renderedImage ?? null);
            } else {
                setProject(null);
